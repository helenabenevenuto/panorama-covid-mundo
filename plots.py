...
def linear_log_scales(x, y, y_axis_name, sup_title, y_label='',
                      ...
                      linear_title='Escala linear',
                      log_title='Escala logarítmica',
...
def hbars_top10(dataframe, column_labels, column_values, sup_title,
                text='', brazil_position=None, padding=-75, font_color='white',
    ...
    if brazil_position:
        bars[brazil_position-1].set(color='green',
                                    edgecolor='yellow', hatch='/', alpha=0.7)
        bars_labels[brazil_position-1].set(color='midnightblue')
